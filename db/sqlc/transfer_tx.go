...
// 2. Add account entires (x2 from/to accounts)
// 3. Updates balance (x2 from/to accounts)
...
func (s *SQLStore) TransferTx(ctx context.Context, arg TransferTxParams) (TransferTxResult, error) {
	...
	fn := func(q *Queries) error {
		...
		/* switch order of accounts, always process lower id first to prevent deadlock */
