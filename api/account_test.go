...
func TestCreateAccountAPI(t *testing.T) {
	...
	testcases := []struct {
	...
	}{
		{
			...
			setupAuth: func(t *testing.T, request *http.Request, tokenMaker token.Maker) {
				addAuthorization(t, request, tokenMaker, user.Username, authorizationTypeBearer, time.Minute)
			},
			buildStubs: func(store *mockdb.MockStore) {
...
func TestGetAccountAPI(t *testing.T) {
	...
	testcases := []struct {
		...
		},
		{
			...
			accountID: account.ID,
			setupAuth: func(t *testing.T, request *http.Request, tokenMaker token.Maker) {
				addAuthorization(t, request, tokenMaker, "unauthorized_user", authorizationTypeBearer, time.Minute)
			},
			buildStubs: func(store *mockdb.MockStore) {
				store.EXPECT().
					GetAccount(gomock.Any(), gomock.Eq(account.ID)).
...
func requireBodyAccountsMatch(t *testing.T, body *bytes.Buffer, accounts []db.Account) {
	data, err := io.ReadAll(body)
	require.NoError(t, err)
